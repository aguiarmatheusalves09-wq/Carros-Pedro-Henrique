class veiculo():
    ...
    def __str__(self):
        return f'Modelo: {self.__modelo} /nTipo: {self.__tipo}/nMarca: {self.__marca} /nPlaca: {self.__placa} /nAno: {self.__ano_fabricao} /nCor: {self.__cor} /nTanque: {self.__tanque} /nAlugado: {self.__alugado}'
